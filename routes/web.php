...
Route::get('showgeneration0/{id}',  "App\Http\Controllers\CalcController@showgeneration0" );
Route::get('calcGeneration0/{id}/{tryb}',  "App\Http\Controllers\CalcController@calcGeneration0" );
