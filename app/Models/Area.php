...
{
    public $table = "area";
    public $fillable = ["name", "data", "hide", "river", "matrixcross", "matrixtribe", "flex", "cronmatrix", "gen0set", "pattern", "tama", "basket", "rabbit", "rabbitjump", "joiner", "isjoiner", "joinerjoiner"];
