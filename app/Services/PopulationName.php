...
class PopulationName
{
    ...
    public $populationName = [
        ...
        114 => "Spirall Mutation", // X
        115 => "Rabbit Jump", // X
        116 => "Joiner Random50Multiple - tryb2", // X
        117 => "Joiner Random50Multiple - tryb2 - better ", // X
    ];

    public $noSelectingPopulation = [-1, 21, 22, 25, 30, 63, 96, 97, 98, 99, 102, 105, 106, 107, 108, 109, 112, 113, 114, 115, 116, 117];
